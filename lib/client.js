				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							configured.length === 0 && available.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: MUTED,
								children: t("empty")
							}) : null,
					...
					usedSources.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("sectionSources") }), usedSources.map((sourceId) => {
							...
							const description = mode === void 0 || mode === "hidden" ? void 0 : state.credentials[`${sourceId}:${mode}`];
