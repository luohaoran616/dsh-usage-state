	...
	factory: (require) => {
		...
		*/
		...
		function buildProviderRows(input) {
			...
			for (const provider of [...input.config.order, ...Object.keys(input.config.providers)]) if (!grouped.has(provider)) grouped.set(provider, {
		...
		*/
		...
		function StatusLine(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), iconTooltip, -1) : null, parts.map((part, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [index > 0 || compact ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
