						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
										...
										onChange: (event) => writeField(["display", "thresholdWarnPercent"], Number(event.target.value)),
										style: { width: "90px" }
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: MUTED,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
										...
										onChange: (event) => writeField(["display", "thresholdCriticalPercent"], Number(event.target.value)),
										style: { width: "90px" }
									})
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									onChange: (event) => writeField(["refresh", "intervalMinutes"], Number(event.target.value)),
									style: { width: "90px" }
								})]
							}),
